 ...
 *
 * NOTE: [ListCards], [ListStashes], [ListCategories], [GetWallet], [GetExpense],
 * [AddExpense], and [UpdateExpense] are also provided by
 * [com.vida.feature.home.di.HomeModule] / [com.vida.feature.expense.di.ExpenseModule]
 * in the same [ViewModelComponent]. Duplicate bindings in the same component will
 * cause a Dagger compilation error, so we only provide the use cases NOT
 * already provided by other feature modules.
 *
 * [SearchExpenses] and [DeleteExpense] are new for this feature and MUST be
 * provided here.
 */
@Module
